from train_val_test import train_val_model, train_val_model_finetune
import shutil
import inspect
...
def train_val_choose(args, block):
    if args.train == 'classify':
        ...
        train_net = train_val_model_finetune.train_classifier
        val_net = train_val_model_finetune.val_classifier
    else:
